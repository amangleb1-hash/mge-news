...
document.addEventListener('DOMContentLoaded', () => {
  const NEWS_DATA = [
    ...
    },
    {
      ...
      "date": "2025-08-18",
      "text": "Президент Кириешек Михаил выступил с заявлением, где рассказал о своей роли в недавних операциях — он отметил, что оказывал политическую и логистическую поддержку союзным силам. Независимые источники пока не подтвердили полноту его утверждений; часть аналитиков считает, что заявления выглядят самохвальбиво и требуют дополнительной проверки. В выступлении также упомянуто, что Огурцы и Аксолотли находятся в зависимости от Кириешек. Михаил сообщил о планах временно отойти от государственных обязанностей и покинуть страну в ближайшее время. Примечание: аудиофайлы недоступны."
    }
  ];
